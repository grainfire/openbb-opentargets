"""openbb_opentargets OBBject Extension - open_targets"""
...
# We ignore this OpenBBWarning: Skipping 'open_targets', name already in user.
...
#    command_output_paths=["/open_targets/candles"],
